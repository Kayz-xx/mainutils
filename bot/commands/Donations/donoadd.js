...
module.exports = {
  ...
  if(!message.member.roles.cache.has(`${data2}`) && !message.member.hasPermission("ADMINISTRATOR")) return message.channel.send('You cant use this command') //replace with staff role id
