...
module.exports = {
    ...
    async execute(client, message, cmd,  args) {
        ...
        message.channel.send({
            ...
            setTimeout(() => {
                embed1.setDescription("Your 1 minute for using calculator is up!")
                embed1.setColor('RED')
                msg.edit({
                    embed: embed1
                })
        ...
        function createButton(lable, style = 'grey') {
            if(lable === 'clear') style = 'red'
            else if (lable === '.') style = 'grey'
            else if (lable === '=') style = 'green'
            else if (isNaN(lable)) style = 'blurple'
