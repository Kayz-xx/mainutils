...
module.exports = {
  ...
  async execute(client, message, cmd,  args) {
        ...
        if(message.author.id !== '491933949686448138') return message.channel.send('This is an owner only command!');//Add your id there so that only you can run this command.
