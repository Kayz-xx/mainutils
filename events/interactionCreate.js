...
module.exports.run = async (client, interaction) => {
  ...
  // }
  if (
    interaction.channel.id === "945760854136209478" ||
    interaction.channel.id === "945760941792981072" ||
    interaction.channel.id === "945757610316013638"
  ) {
    ...
    async function EcolorRole(interaction, role) {
      await interaction.deferUpdate();
      if (
        !interaction.member.roles.cache.hasAny("768840484906729473", "764885367249174615", "792500623462629386")
      )
        return interaction.followUp({
