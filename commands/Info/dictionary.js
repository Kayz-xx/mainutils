...
module.exports = {
    ...
    async execute(client, message, cmd,  args) {
        ...
        const response = await fetch(`https://api.urbandictionary.com/v0/define?term=${args}`)
        ...
        try {
            ...
            const embed = new MessageEmbed()
                ...
                embed.setFooter(`${message.author.tag}`, message.author.displayAvatarURL({dynamic: false}))
