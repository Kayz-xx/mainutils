  ...
  async execute(client, message, cmd, args) {
    ...
    try {
      ...
      if (denyQuery === "event manager") {
        ...
        denyQuery =
          "Your application for karuta manager has been denied, thank you for applying!";
      } else if (denyQuery === "partnership manager") {
        denyQuery =
          "Your application for partnership manager has been denied, thank you for applying!";
      }
      user.send({
        embeds: [
          {
