...
module.exports = {
	...
	async execute(client, message, cmd, args) {
		...
		String.prototype.capitalize = function() {
		 ...
		 if(!data.Positions0) return message.author.send({embeds: [
			new Discord.MessageEmbed()
				...
				else if(!data.Positions1) return message.author.send({embeds: [
					new Discord.MessageEmbed()
						.setTitle(`An Error Occurred`)
						.setColor('DA0037')
						.setDescription(
						...
						else if(!data.Positions2) return message.author.send({embeds: [
							new Discord.MessageEmbed()
								.setTitle(`An Error Occurred`)
								.setColor('DA0037')
								.setDescription(
								...
								else if(!data.Positions3) return message.author.send({embeds: [
									new Discord.MessageEmbed()
										.setTitle(`An Error Occurred`)
										.setColor('DA0037')
										.setDescription(
		...
		const msg = await message.author.send({embeds: [
			new Discord.MessageEmbed()
				.setColor('#0099ff')
