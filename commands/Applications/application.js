    ...
    if (message.channel.id === "764885369933791299") {
      ...
      const collected = await msg.channel
        ...
        .then(async (message) => {
          ...
          let data =
            (await db
              .ref(`Applications/${guildid}/Positions${num.toString()}`)
              .once("value")
              .then((snapshot) => snapshot.val())) || [];
          ...
          message.author.send({
            embeds: [
              new Discord.MessageEmbed()
                .setTitle(`Apply For ${data.Name}: ${message.author.tag}`)
                .setColor("#0099ff")
          ...
          const msg = await message.author.send({
            embeds: [
              new Discord.MessageEmbed()
                .setTitle(`Ready?`)
                .setColor("#0099ff")
                .setAuthor("Ready to apply? (Use buttons to continue)")
                .addFields(
                  {
          ...
          collector3.on("collect", async (btn) => {
            ...
            if (btn.customId == "1") {
              ...
              collector.on("collect", async (m) => {
                ...
                if (collectCounter < questions.length) {
                  ...
                  let msg2 = await channel.send({
                    embeds: [
                      {
                        description: "Do you want to send your application?",
                        color: "#77ACF1",
                      },
                    ],
                    components: [row],
              ...
              const appsChannel =
                client.channels.cache.get("764885370558349373");
