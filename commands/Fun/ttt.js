...
try {
    ...
    async function tictactoe(m) {
        ...
        if (Args.a1.emoji == "<:TTTX:875313137019142146>" && Args.b1.emoji == "<:TTTX:875313137019142146>" && Args.c1.emoji == "<:TTTX:875313137019142146>") won["❌"] = true
        if (Args.a2.emoji == "<:TTTX:875313137019142146>" && Args.b2.emoji == "<:TTTX:875313137019142146>" && Args.c2.emoji == "<:TTTX:875313137019142146>") won["❌"] = true
        if (Args.a3.emoji == "<:TTTX:875313137019142146>" && Args.b3.emoji == "<:TTTX:875313137019142146>" && Args.c3.emoji == "<:TTTX:875313137019142146>") won["❌"] = true
        if (Args.a1.emoji == "<:TTTX:875313137019142146>" && Args.b2.emoji == "<:TTTX:875313137019142146>" && Args.c3.emoji == "<:TTTX:875313137019142146>") won["❌"] = true
        if (Args.a3.emoji == "<:TTTX:875313137019142146>" && Args.b2.emoji == "<:TTTX:875313137019142146>" && Args.c1.emoji == "<:TTTX:875313137019142146>") won["❌"] = true
        if (Args.a1.emoji == "<:TTTX:875313137019142146>" && Args.a2.emoji == "<:TTTX:875313137019142146>" && Args.a3.emoji == "<:TTTX:875313137019142146>") won["❌"] = true
        if (Args.b1.emoji == "<:TTTX:875313137019142146>" && Args.b2.emoji == "<:TTTX:875313137019142146>" && Args.b3.emoji == "<:TTTX:875313137019142146>") won["❌"] = true
        if (Args.c1.emoji == "<:TTTX:875313137019142146>" && Args.c2.emoji == "<:TTTX:875313137019142146>" && Args.c3.emoji == "<:TTTX:875313137019142146>") won["❌"] = true
        if (won["❌"] != false) return m.edit({content:'❌ won!', components: []})
