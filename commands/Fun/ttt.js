  ...
  async execute(client, message, cmd, args) {
    try {
      ...
      let msg = await message.channel.send({
        content: `**${message.member.displayName} vs ${opponent.displayName}**\n **TicTacToe** | <@!${Args.userid}>'s turn (⭕)`,
      });
      tictactoe(msg);
      async function tictactoe(m) {
        ...
        if (
          Args.a1.emoji == "<:TTTO:873550866915942430>" &&
          Args.b1.emoji == "<:TTTO:873550866915942430>" &&
          Args.c1.emoji == "<:TTTO:873550866915942430>"
        )
          won["⭕"] = true;
        if (
          Args.a2.emoji == "<:TTTO:873550866915942430>" &&
          Args.b2.emoji == "<:TTTO:873550866915942430>" &&
          Args.c2.emoji == "<:TTTO:873550866915942430>"
        )
          won["⭕"] = true;
        if (
          Args.a3.emoji == "<:TTTO:873550866915942430>" &&
          Args.b3.emoji == "<:TTTO:873550866915942430>" &&
          Args.c3.emoji == "<:TTTO:873550866915942430>"
        )
          won["⭕"] = true;
        if (
          Args.a1.emoji == "<:TTTO:873550866915942430>" &&
        ...
        if (
          ...
          won["⭕"] = true;
        if (won["⭕"] != false)
          return m.edit({ content: "⭕ won!", components: [] });
        if (
          Args.a1.emoji == "<:TTTX:875313137019142146>" &&
          Args.b1.emoji == "<:TTTX:875313137019142146>" &&
          Args.c1.emoji == "<:TTTX:875313137019142146>"
        )
          won["❌"] = true;
        if (
          Args.a2.emoji == "<:TTTX:875313137019142146>" &&
          Args.b2.emoji == "<:TTTX:875313137019142146>" &&
          Args.c2.emoji == "<:TTTX:875313137019142146>"
        )
          won["❌"] = true;
        if (
          Args.a3.emoji == "<:TTTX:875313137019142146>" &&
          Args.b3.emoji == "<:TTTX:875313137019142146>" &&
          Args.c3.emoji == "<:TTTX:875313137019142146>"
        )
          won["❌"] = true;
        if (
          Args.a1.emoji == "<:TTTX:875313137019142146>" &&
        ...
        m.edit({
          content: `**${message.member.displayName} vs ${
