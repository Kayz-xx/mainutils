...
const economy3 = require("../../functions/owo");
const { MessageEmbed } = require("discord.js");
const Discord = require("discord.js");
const formatter = new Intl.NumberFormat("en");
const { db } = require("../../firebase.js");
const eventdonations = require("../../functions/eventdonations");
...
module.exports = {
  ...
  async execute(client, message, cmd, args) {
    ...
    if (cmd === "eventdonoadd") {
      ...
      if (type === "karuta")
        await economy2.addCoins(guildId, userId, eventcoins);
