...
module.exports = {
  ...
  async execute(client, message, cmd, args) {
    if (
      !message.member.roles.cache.has("770365283147317248") &&
    ...
    const embed = new MessageEmbed()
      ...
      .addField(
        `<a:EE_nyaspin:787259537408786442> Requirement`,
        `${requirement}`
      )
      ...
      .setColor("RANDOM")
      .setImage(
        `https://cdn.discordapp.com/attachments/855828767846039582/859816740987600906/tnbIcOg.png`
      );
    message.channel.send({
      content: `<@&767787322133184542>`,
      embeds: [embed],
    });
  },
};
