...
module.exports = {
    ...
    try {
        ...
        message.channel.send(`<#${channel.id}> has been viewlocked for \`${role.name}\``)

        } catch (error) {
            message.channel.send('There was an error viewlocking the channel, please make sure there are no errors.')
        }
	},
};
